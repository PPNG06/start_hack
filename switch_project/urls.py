...
from file_app.views import home, presentation, upload_view, institution_sign_up, institution_login, institution_profile, institution_logout, student_sign_up, student_login,student_profile, student_logout
urlpatterns = [
